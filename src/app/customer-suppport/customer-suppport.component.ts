...
@Component({
  selector: 'app-customer-suppport',
  templateUrl: './customer-suppport.component.html',
  styleUrls: ['./customer-suppport.component.scss']
})
export class CustomerSuppportComponent implements OnInit {
